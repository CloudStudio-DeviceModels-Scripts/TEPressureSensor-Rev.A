...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  var bat = endpoints.addEndpoint("1", "Battery", endpointType.genericSensor);
  bat.variableTypeId = 1225;
  var cnt = endpoints.addEndpoint("2", "Count", endpointType.genericSensor);
  cnt.variableTypeId = 1226;
  endpoints.addEndpoint("3", "Pressure sensor", endpointType.pressureSensor);
  endpoints.addEndpoint("4", "Temperature sensor", endpointType.temperatureSensor);
  var rssi = endpoints.addEndpoint("5", "RSSI", endpointType.genericSensor);
